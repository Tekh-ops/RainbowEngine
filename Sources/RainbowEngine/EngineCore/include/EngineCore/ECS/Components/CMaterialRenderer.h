...
namespace EngineCore::ECS::Components
{
	...
	*/
	class API_ENGINECORE CMaterialRenderer : public AComponent
	{
	public:
		using MaterialList = std::array<EngineCore::Resources::Material*, MAX_MATERIAL_COUNT>;
		...
		* @param p_material
		*/
		void FillWithMaterial(EngineCore::Resources::Material& p_material);
		...
		* @param p_material
		*/
		void SetMaterialAtIndex(uint8_t p_index, EngineCore::Resources::Material& p_material);

		/**
		* Returns the material to use at index
		* @param p_index
		*/
		EngineCore::Resources::Material* GetMaterialAtIndex(uint8_t p_index);
		...
		* @param p_instance
		*/
		void RemoveMaterialByInstance(EngineCore::Resources::Material& p_instance);
