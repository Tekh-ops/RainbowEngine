...
namespace EngineCore::ECS
{
	...
	*/
	class API_ENGINECORE Actor : public API::ISerializable
	{
	public:
		/**
		...
		* @param p_component
		*/
		bool RemoveComponent(EngineCore::ECS::Components::AComponent& p_component);
...
#include "EngineCore/ECS/Actor.inl"