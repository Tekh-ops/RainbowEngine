...
namespace Rendering::Data
{
	...
	*/
	...
	public:
		...
		* @param p_transform
		*/
		bool BoundingSphereInFrustum(const Rendering::Geometry::BoundingSphere& p_boundingSphere, const OvMaths::FTransform& p_transform) const;
