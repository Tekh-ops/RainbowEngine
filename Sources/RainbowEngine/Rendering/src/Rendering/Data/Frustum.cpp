...
void Rendering::Data::Frustum::CalculateFrustum(const OvMaths::FMatrix4& p_viewProjection)
{
...
bool Rendering::Data::Frustum::BoundingSphereInFrustum(const Rendering::Geometry::BoundingSphere& p_boundingSphere, const OvMaths::FTransform& p_transform) const
{
