...
Rendering::Entities::Light::Light(OvMaths::FTransform & p_tranform, Type p_type) : m_transform(p_tranform), type(static_cast<float>(p_type))
{
	
}

OvMaths::FMatrix4 Rendering::Entities::Light::GenerateMatrix() const
{
...
const OvMaths::FTransform& Rendering::Entities::Light::GetTransform() const
{
	return m_transform;
}
