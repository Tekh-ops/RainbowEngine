...
void Editor::Panels::AssetProperties::Preview()
{
	...
	{
		if (auto resource = OVSERVICE(EngineCore::ResourceManagement::ModelManager).GetResource(m_resource))
		{
	...
	{
		if (auto resource = OVSERVICE(EngineCore::ResourceManagement::TextureManager).GetResource(m_resource))
		{
			assetView.SetResource(resource);
		}
	}
...
void Editor::Panels::AssetProperties::CreateAssetSelector()
{
    ...
    m_assetSelector = &EngineCore::Helpers::GUIDrawer::DrawAsset(columns, "Target", m_resource, &m_targetChanged);
}
...
void Editor::Panels::AssetProperties::CreateInfo()
{
    ...
    if (std::filesystem::exists(realPath))
    {
        ...
        EngineCore::Helpers::GUIDrawer::CreateTitle(*m_infoColumns, "Path");
        m_infoColumns->CreateWidget<UI::Widgets::Texts::Text>(realPath);

        EngineCore::Helpers::GUIDrawer::CreateTitle(*m_infoColumns, "Size");
        ...
        EngineCore::Helpers::GUIDrawer::CreateTitle(*m_infoColumns, "Metadata");
...
#define MODEL_FLAG_ENTRY(setting) EngineCore::Helpers::GUIDrawer::DrawBoolean(*m_settingsColumns, setting, [&]() { return m_metadata->Get<bool>(setting); }, [&](bool value) { m_metadata->Set<bool>(setting, value); })
...
void Editor::Panels::AssetProperties::CreateTextureSettings()
{
	...
	EngineCore::Helpers::GUIDrawer::CreateTitle(*m_settingsColumns, "MIN_FILTER");
	...
	EngineCore::Helpers::GUIDrawer::CreateTitle(*m_settingsColumns, "MAG_FILTER");
	...
	EngineCore::Helpers::GUIDrawer::DrawBoolean(*m_settingsColumns, "ENABLE_MIPMAPPING", [&]() { return m_metadata->Get<bool>("ENABLE_MIPMAPPING"); }, [&](bool value) { m_metadata->Set<bool>("ENABLE_MIPMAPPING", value); });
}
