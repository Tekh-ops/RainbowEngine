...
) : PanelWindow(p_title, p_opened, p_windowSettings)
{
	...
	auto& textureManager = EngineCore::Global::ServiceLocator::Get<EngineCore::ResourceManagement::TextureManager>();

	m_playButton	= &CreateWidget<UI::Widgets::Buttons::ButtonImage>(EDITOR_CONTEXT(editorResources)->GetTexture("Button_Play")->id, OvMaths::FVector2{ 20, 20 });
	m_pauseButton	= &CreateWidget<UI::Widgets::Buttons::ButtonImage>(EDITOR_CONTEXT(editorResources)->GetTexture("Button_Pause")->id, OvMaths::FVector2{ 20, 20 });
	m_stopButton	= &CreateWidget<UI::Widgets::Buttons::ButtonImage>(EDITOR_CONTEXT(editorResources)->GetTexture("Button_Stop")->id, OvMaths::FVector2{ 20, 20 });
	m_nextButton	= &CreateWidget<UI::Widgets::Buttons::ButtonImage>(EDITOR_CONTEXT(editorResources)->GetTexture("Button_Next")->id, OvMaths::FVector2{ 20, 20 });
