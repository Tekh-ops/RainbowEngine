...
Windowing::Dialogs::FileDialog::FileDialog(std::function<int(tagOFNA*)> p_callback, const std::string & p_dialogTitle) :
...
void Windowing::Dialogs::FileDialog::SetInitialDirectory(const std::string & p_initialDirectory)
{
	m_initialDirectory = p_initialDirectory;
}

void Windowing::Dialogs::FileDialog::Show(EExplorerFlags p_flags)
{
	OPENFILENAME ofn;
...
bool Windowing::Dialogs::FileDialog::HasSucceeded() const
{
	return m_succeeded;
}

std::string Windowing::Dialogs::FileDialog::GetSelectedFileName()
{
	return m_filename;
}

std::string Windowing::Dialogs::FileDialog::GetSelectedFilePath()
{
	return m_filepath;
}

std::string Windowing::Dialogs::FileDialog::GetErrorInfo()
{
	return m_error;
}

bool Windowing::Dialogs::FileDialog::IsFileExisting() const
{
	return std::filesystem::exists(m_filepath);
}

void Windowing::Dialogs::FileDialog::HandleError()
{
