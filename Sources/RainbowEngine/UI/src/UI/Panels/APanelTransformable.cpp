...
void UI::Panels::APanelTransformable::SetPosition(const OvMaths::FVector2& p_position)
{
	m_position = p_position;
	m_positionChanged = true;
}

void UI::Panels::APanelTransformable::SetSize(const OvMaths::FVector2& p_size)
{
	m_size = p_size;
	m_sizeChanged = true;
}
...
const OvMaths::FVector2 & UI::Panels::APanelTransformable::GetPosition() const
{
	return m_position;
}

const OvMaths::FVector2 & UI::Panels::APanelTransformable::GetSize() const
{
	return m_size;
}
...
OvMaths::FVector2 UI::Panels::APanelTransformable::CalculatePositionAlignmentOffset(bool p_default)
{
